...
image: '/images/placeholder-design.svg'
---

Most design systems don't fail because of technology. They fail because of trust, adoption, and the gap between what we prescribe and what people actually need.
...
When teams don't trust the system, they fork. Quietly at first. A custom button here, a tweaked color there. Over time, the fork becomes the real system, and the official one becomes a museum of good intentions.
...
From what I've seen, these patterns hold:

- **Start small.** Don't try to systematize everything at once. Cover the 20% that 80% of teams need.
- **Co-design with consumers.** The teams using the system should help shape it. Otherwise it's a solution looking for a problem.
- **Make contribution easy.** If proposing a change takes a week of review, people will just build their own.
...
*This is a note, not a definitive guide. Your mileage will vary. I'd love to hear where your design system succeeded or struggled — ping me on [Twitter](https://twitter.com/bhaumikkaji) or email me at bhaumik@bhaumikkaji.com.*